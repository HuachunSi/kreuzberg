...
// alef:hash:de4e0822693215498c04f309eab88f568896bc0ea5a75b5a68ca646b65a47979
...
impl TableTableGrid {
    ...
    #[new]
    pub fn new(columns: Option<Vec<i32>>) -> Self {
        Self {
...
impl ExtractionResult2 {
    #[must_use]
    #[pyo3(signature = (content, mime_type, metadata, tables))]
    #[new]
    pub fn new(content: String, mime_type: String, metadata: HashMap<String, String>, tables: Vec<Table>) -> Self {
        Self {
            content,
            mime_type,
            metadata,
...
impl Table2 {
    #[must_use]
    #[pyo3(signature = (cells, markdown, page_number))]
    #[new]
    pub fn new(cells: Vec<Vec<String>>, markdown: String, page_number: i32) -> Self {
        Self {
            cells,
            markdown,
            page_number,
