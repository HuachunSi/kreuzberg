...
// alef:hash:59bf6b2dc7b270443ddb159feae6e30e4dfd875b5b9b4852f160eb82d77fb948
...
func Test_ConfigSecurityLimits(t *testing.T) {
	...
	{
		found := false
		if strings.Contains(fmt.Sprint(result.MimeType), `application/zip`) { found = true }
		if strings.Contains(fmt.Sprint(result.MimeType), `application/x-zip-compressed`) { found = true }
		if !found {
