...
// alef:hash:8c595d4cad7648ea1a2a519802542cd0fb8e4fb199ae0a1769afe158745c66c0
...
func Test_FormatPdfText(t *testing.T) {
	...
	{
		found := false
		if strings.Contains(fmt.Sprint(result.Content), `Mallori`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `May`) { found = true }
		if !found {
