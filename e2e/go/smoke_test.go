...
// alef:hash:21d9ad3a20ba9307fa47be6febb02b762da0c75e94aa8ba377d8b52892beb110
...
func Test_OcrImagePng(t *testing.T) {
	...
	{
		found := false
		if strings.Contains(fmt.Sprint(result.Content), `Hello`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `World`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `hello`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `world`) { found = true }
		if !found {
...
func Test_SmokeDocxBasic(t *testing.T) {
	...
	{
		found := false
		if strings.Contains(fmt.Sprint(result.Content), `Lorem`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `ipsum`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `document`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `text`) { found = true }
		if !found {
			t.Errorf("expected to contain at least one of the specified values")
		}
	}
...
func Test_SmokeHtmlBasic(t *testing.T) {
	...
	{
		found := false
		if strings.Contains(fmt.Sprint(result.Content), `Sample Data Table`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `Laptop`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `Electronics`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `Product`) { found = true }
		if !found {
			t.Errorf("expected to contain at least one of the specified values")
		}
	}
...
func Test_SmokePdfBasic(t *testing.T) {
	...
	{
		found := false
		if strings.Contains(fmt.Sprint(result.Content), `May 5, 2023`) { found = true }
		if strings.Contains(fmt.Sprint(result.Content), `To Whom it May Concern`) { found = true }
		if !found {
			t.Errorf("expected to contain at least one of the specified values")
		}
	}
