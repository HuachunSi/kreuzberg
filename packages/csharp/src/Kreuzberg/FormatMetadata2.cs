...
// alef:hash:06ebf8fceb7c71d34b0d0bcb54959515449b06ce1ce664349a18e67affad7fd3
...
public sealed class FormatMetadata2JsonConverter : JsonConverter<FormatMetadata2>
{
    ...
    public override void Write(Utf8JsonWriter writer, FormatMetadata2 value, JsonSerializerOptions options)
    {
        ...
        {            case FormatMetadata2.Pdf v_pdf:
                tag = "pdf";                inner = v_pdf.Value;                break;            case FormatMetadata2.Docx v_docx:
                tag = "docx";                inner = v_docx.Value;                break;            case FormatMetadata2.Excel v_excel:
                tag = "excel";                inner = v_excel.Value;                break;            case FormatMetadata2.Email v_email:
                tag = "email";                inner = v_email.Value;                break;            case FormatMetadata2.Pptx v_pptx:
                tag = "pptx";                inner = v_pptx.Value;                break;            case FormatMetadata2.Archive v_archive:
                tag = "archive";                inner = v_archive.Value;                break;            case FormatMetadata2.Image v_image:
                tag = "image";                inner = v_image.Value;                break;            case FormatMetadata2.XML v_xml:
                tag = "xml";                inner = v_xml.Value;                break;            case FormatMetadata2.Text v_text:
                tag = "text";                inner = v_text.Value;                break;            case FormatMetadata2.HTML v_html:
                tag = "html";                inner = v_html.Value;                break;            case FormatMetadata2.Ocr v_ocr:
                tag = "ocr";                inner = v_ocr.Value;                break;            case FormatMetadata2.Csv v_csv:
                tag = "csv";                inner = v_csv.Value;                break;            case FormatMetadata2.Bibtex v_bibtex:
                tag = "bibtex";                inner = v_bibtex.Value;                break;            case FormatMetadata2.Citation v_citation:
                tag = "citation";                inner = v_citation.Value;                break;            case FormatMetadata2.FictionBook v_fictionbook:
                tag = "fiction_book";                inner = v_fictionbook.Value;                break;            case FormatMetadata2.Dbf v_dbf:
                tag = "dbf";                inner = v_dbf.Value;                break;            case FormatMetadata2.Jats v_jats:
                tag = "jats";                inner = v_jats.Value;                break;            case FormatMetadata2.Epub v_epub:
                tag = "epub";                inner = v_epub.Value;                break;            case FormatMetadata2.Pst v_pst:
                tag = "pst";                inner = v_pst.Value;                break;            case FormatMetadata2.Code v_code:
