...
impl From<kreuzberg::extraction::docx::table::TableGrid> for TableTableGrid {
    fn from(v: kreuzberg::extraction::docx::table::TableGrid) -> Self {
        TableTableGrid {
            columns: v.columns.into_iter().map(|x| x as _).collect(),
        }
    }
}
...
impl From<kreuzberg::ocr::ExtractionResult> for ExtractionResult2 {
    fn from(v: kreuzberg::ocr::ExtractionResult) -> Self {
        ExtractionResult2 {
            content: v.content.into(),
            mime_type: v.mime_type.into(),
            metadata: v
...
impl From<kreuzberg::ocr::Table> for Table2 {
    fn from(v: kreuzberg::ocr::Table) -> Self {
        Table2 {
            cells: v.cells,
            markdown: v.markdown.into(),
            page_number: v.page_number as _,
...
pub fn get_embedding_preset(name: String) -> Option<String> {
    kreuzberg::get_embedding_preset(&name).map(|s| s.to_string())
}
...
#[frb]
pub fn create_table_table_grid_from_json(json: String) -> Result<TableTableGrid, String> {
...
#[frb]
pub fn create_extraction_result2_from_json(json: String) -> Result<ExtractionResult2, String> {
...
#[frb]
pub fn create_table2_from_json(json: String) -> Result<Table2, String> {
