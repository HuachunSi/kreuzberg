...
# alef:hash:31affd3699989a1dce016984200c5eaf6e0db3611bb66fd4349634f89c9b3bd9
...
defmodule Kreuzberg.Native do
  ...
  * `tier` - `"mobile"` (default, lightweight, faster) or `"server"` (high accuracy, GPU/complex documents)
  ...
  def table_table_grid_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def extraction_result2_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
  def table2_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
