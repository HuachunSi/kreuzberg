...
// alef:hash:468dd398e42a2c903a33cb0e3a08a6ee1d9f3d572d706cc633e7187617edf309
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Kreuzberg.ExtractionResult2"]
...
#[rustler::nif]
pub fn table_table_grid_from_json(json: String) -> Result<TableTableGrid, String> {
    serde_json::from_str::<kreuzberg::extraction::docx::table::TableGrid>(&json)
        .map(TableTableGrid::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn extraction_result2_from_json(json: String) -> Result<ExtractionResult2, String> {
    serde_json::from_str::<kreuzberg::ocr::ExtractionResult>(&json)
        .map(ExtractionResult2::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn table2_from_json(json: String) -> Result<Table2, String> {
    serde_json::from_str::<kreuzberg::ocr::Table>(&json)
        .map(Table2::from)
        .map_err(|e| e.to_string())
}
