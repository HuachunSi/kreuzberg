...
// alef:hash:3e4b2d07fc8603a78fd400cc08175b0383485ad3606bc692fce95b61b22b9903
...
// TableTableGrid column widths from `<w:tblGrid>`.
type TableTableGrid struct {
...
// ExtractionResult2 oCR extraction result
type ExtractionResult2 struct {
	Content string `json:"content"`
	MimeType string `json:"mime_type"`
	Metadata map[string]json.RawMessage `json:"metadata,omitempty"`
	Tables []Table `json:"tables,omitempty"`
...
// Table2 extracted table from OCR
type Table2 struct {
	Cells [][]string `json:"cells,omitempty"`
	Markdown string `json:"markdown"`
...
func DetectMimeTypeFromBytes(content []byte) (*string, error) {
	...
	defer C.kreuzberg_free_string(ptr)
	return func() *string { if ptr == nil { return nil }; v := C.GoString(ptr); return &v }(), nil
}
...
func GetEmbeddingPreset(name string) *string {
	...
	return func() *string { if ptr == nil { return nil }; v := C.GoString(ptr); return &v }()
}
