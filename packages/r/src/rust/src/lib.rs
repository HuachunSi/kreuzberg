...
// alef:hash:14ca734fb1b4a626343e69abc4a9b7f5f6134685fdda525b383b7e0da464e20b
...
#[extendr]
pub fn new_tabletablegrid(columns: Option<Vec<i32>>) -> TableTableGrid {
    let mut __out = <TableTableGrid>::default();
